...
class StoreRequest extends FormRequest
{
    ...
    {
        return Gate::allows(config('models.product.permissions.create'));
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'image_url'   => 'required_without:image|nullable|active_url|string|max:191',
            'image'       => 'required_without:image_url|nullable|string|max:191',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'image_url.required_without' => __('validation/admin.product_image_url_required_unless'),
            ...
            'image.required_without'     => __('validation/admin.image_required_unless'),
