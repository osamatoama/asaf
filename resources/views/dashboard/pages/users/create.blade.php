...
@section('content')
    <div class="card h-100">
        <div class="card-inner">
            <div class="card-head">
                <h5 class="card-title">إضافة موظف</h5>
            </div>
                                ...
                                <select class="form-control select2-init @error('role') is-invalid @enderror"
                                    ...
                                    @foreach($roles as $role)
                                        <option value="{{ $role->id }}"
                                                @if(isSelected('role', $role->id)) selected @endif>
                                            {{ $role->title }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input class="form-control @error('verification_code') is-invalid @enderror"
                                       ...
                                       id="verification_code" value="{{ old('verification_code') }}">
                            ...
                            <div class="form-control-wrap">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input"
                                           ...
                                           @if(isChecked('verified')) checked @endif>
                            ...
                            <div class="form-control-wrap">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input"
                                           ...
                                           @if(isChecked('active')) checked @endif>
